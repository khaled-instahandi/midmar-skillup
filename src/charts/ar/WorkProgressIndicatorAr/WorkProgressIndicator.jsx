...
const WorkProgressIndicatorAr = ({ monthsElapsed, totalMonths }) => {
    ...
    return (
        <div className="timeline-container-c" dir='ltr'>
            <div className="timeline-header">
                <h2>عدد أشهر حضور التدريبات</h2>
            </div>
            <div className="progress-bar-v">
                <div className="months-indicator" style={{ width: `${progressPercentage}%` }}>{monthsElapsed} أشهر</div>
                ...
                <div className="text-thumb">
                    <div className="text-thumb-start" >بداية الحضور </div>
                    <div className="text-thumb-current" style={{ width: `${progressPercentage}%` }}>تاريح اليوم </div>

                    <div className="text-thumb-end" style={{ width: '100%' }}>نهاية السنة </div>
                </div>
...
export default WorkProgressIndicatorAr;

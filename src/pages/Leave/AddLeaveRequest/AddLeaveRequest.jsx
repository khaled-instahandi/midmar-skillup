...
import CompensativeVacationNote from "./CompensativeVacationNote/CompensativeVacationNote";
import DelegationForm from "./DelegationForm/DelegationForm";
import ApprovalFields from "./ApprovalFields/ApprovalFields";
import HRFields from "./HRFields/HRFields";
...
const AddLeaveRequest = ({
  ...
  return (
    <Modal onClose={onClose} scale={scale} height={"100%"} width={"auto"}>
                ...
                <div className="time-selection-section">
                  ...
                  <div className="time-type">
                    <CustomCheckbox
                      id="hour"
                      name="isHourly"
                      isChecked={leaveDetails.isHourly}
                      hund={() =>
                        setLeaveDetails({ ...leaveDetails, isHourly: true })
                      }
                    />
                    ...
                    <CustomCheckbox
                      ...
                      isChecked={!leaveDetails.isHourly}
                      hund={() =>
                        setLeaveDetails({ ...leaveDetails, isHourly: false })
                      }
                    />

                    <label htmlFor="date">Date</label>
                  </div>
                  {leaveDetails.isHourly ? (
                    <div className="hour-inputs">
                      ...
                      <input
                        ...
                        value={leaveDetails.numberOfHours}
                        onChange={handleChange}
                      />
                    </div>
                  ) : (
                    <div className="date-inputs">
                      ...
                      <input
                        ...
                        value={leaveDetails.numberOfDays}
                        onChange={handleChange}
                      />
                    </div>
                  )}

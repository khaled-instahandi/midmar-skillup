...
const sampleData = [
  {
    ...
    RequiredAction:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do  ",
    Responsible: "M.Ahmad",
    EngagementStrategy: "Lorem ipsum dolor",
      ...
      <div className="activity-table-container">
          ...
          <table className="activity-table" style={{ width: "100%" }}>
            <thead>
              <tr className="activity-table-header">
                <th
                  style={{ width: "25%" }}
                  onClick={() => toggleSort("PowerLevel")}
                >
                  Power Level{" "}
                </th>
                <th onClick={() => toggleSort("RequiredAction")}>
                  Required Action
                </th>
                <th onClick={() => toggleSort("Responsible")}>Responsible</th>
                <th onClick={() => toggleSort("EngagementStrategy")}>
                  Engagement Strategy
                </th>

                <th onClick={() => toggleSort("CommunicationMethod")}>
              ...
              {currentItems.map((activity) => (
                <React.Fragment key={activity.id}>
                  <tr className={`activity-table-row `}>
                    <td style={{ minWidth: "330px" }}>{activity.PowerLevel}</td>
                    <td style={{ minWidth: "300px" }}>
                      {activity.RequiredAction}
                    </td>
        ...
        {showAlertConfirm && (
          <AlertMessage
            ...
            buttomText={"You will not be able to recover this Stakeholder!!"}
        ...
        {showAlertDelete && (
          <AlertMessage
            ...
            buttomText={"Hey, This Stakeholder has been deleted!!"}
            buttomTextMiddle={true}
            closeButton
            onClose={handleModalClose}
          />

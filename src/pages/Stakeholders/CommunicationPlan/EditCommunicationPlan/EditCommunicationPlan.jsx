...
const EditCommunicationPlan = ({
  ...
  return (
    <Modal onClose={onClose} height={"80%"} width={"auto"}>
      <h2 className="header-text-edit-project">Edit a Communication plan</h2>
      ...
      <form onSubmit={handleSubmit} className="edit-project-form">
        ...
        <Button
          type="submit"
          label="Edit a Communication plan"
...
export default EditCommunicationPlan;

...
const EditRecruitmentPlan = ({
  ...
  return (
    <Modal onClose={onClose} height={"80%"} width={"auto"}>
      <h2 className="header-text-edit-project">Edit a Recruitment plan</h2>
...
export default EditRecruitmentPlan;

...
import AddRecruitmentPlan from "./AddRecruitmentPlan/AddRecruitmentPlan";
import EditRecruitmentPlan from "./EditRecruitmentPlan/EditRecruitmentPlan";
// import AddStakeholders from '../AddStakeholders/AddStakeholders';
// import EditStakeholders from '../EditStakeholders/EditStakeholders';
...
const sampleData = [
  {
    id: 1,
    HumanResource: "trainer",
    PlannedDate: "12/12/2023",
    DurationInDays: "60",
    ContractDurationInMonths: "3",
    RequiredWorkStartDate: "01/01/2024",
    Responsibilities: "Training students",
  },
  {
    id: 2,
    HumanResource: "trainer",
      ...
      <div className="activity-table-container">
          ...
          <table className="activity-table" style={{ width: "100%" }}>
            <thead>
              <tr className="activity-table-header">
                <th onClick={() => toggleSort("HumanResource")}>
                  HumanResource
                </th>
                <th onClick={() => toggleSort("PlannedDate")}>PlannedDate</th>
                <th onClick={() => toggleSort("DurationInDays")}>
                  DurationInDays
                </th>
                <th onClick={() => toggleSort("ContractDurationInMonths")}>
                  ContractDurationInMonths
                </th>

                <th onClick={() => toggleSort("RequiredWorkStartDate")}>
                  RequiredWorkStartDate
                </th>
                <th onClick={() => toggleSort("Responsibilities")}>
                  Responsibilities
                </th>
        ...
        {showAlertConfirm && (
          <AlertMessage
            ...
            buttomText={
              "You will not be able to recover this Recruitment plan!!"
            }
        ...
        {showAlertDelete && (
          <AlertMessage
            ...
            buttomText={"Hey, This Recruitment plan has been deleted!!"}
            buttomTextMiddle={true}
            closeButton
            onClose={handleModalClose}
          />
...
export default RecruitmentPlanTable;

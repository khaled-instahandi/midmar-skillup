...
const AddPurchaseRequests = ({ isOpen, onClose, projectData, onSave }) => {
  ...
  return (
    <Modal onClose={onClose} height={"100%"} width={"auto"}>
      <h2 className="header-text-edit-project">Add purchase Request</h2>
...
export default AddPurchaseRequests;

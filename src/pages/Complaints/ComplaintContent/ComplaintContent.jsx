...
const ComplaintContent = ({
  ...
  const complaintText =
    "He needs a big smile. Mauris flatters the elit, needs the tincidunt nibh pulvinarHe needs a big smile. Mauris flatters the elit, needs the tincidunt nibh pulvinar";
  ...
  return (
    <Modal onClose={onClose} height={"auto"} width={"auto"}>

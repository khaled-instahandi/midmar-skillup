...
const sampleData = [
    {
        id: 1, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Closed", Replay: "الرد معلق", Replydate: "15/12/2023"
    },
    {
        id: 2, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },
    {
        id: 3, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },
    {
        id: 4, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    }
    ,
    {
        id: 5, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },
    {
        id: 6, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },
    {
        id: 7, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },
    {
        id: 8, UserIdentity: "غير معروف", Text: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", SendingDate: "15/12/2023", Status: "Sent", Replay: "انه يحتاج الى ابتسامة كبيرة. موريس يتملق النخبة، ويحتاج إلى نبته بولفينار", Replydate: "15/12/2023"
    },

];
const defaultData = [...sampleData];

const ComplaintContentApprentice = () => {
                    ...
                    <table className="activity-table" style={{ width: '100%' }}>
                        <thead>
                            <tr className='activity-table-header'>
                                ...
                                <th onClick={() => toggleSort('UserIdentity')}>هوية المستخدم</th>
                                ...
                                <React.Fragment key={activity.id}>
                                    ...
                                    >
                                        ...
                                        <td >
                                            ...
                                            {activity.UserIdentity}
                                        </td>
                                        <td className='truncate-text' >
                                            {/* {activity.Text} */}
                                            {activity.Text.length > 30 ? `${activity.Text.substring(0, 30)}...` : activity.Text}

                                        </td>
                                        <td>
                                            {activity.SendingDate}
                                        </td>
                                        <td className="activity-status" >
                                            {/* {activity.Status} */}
                                            {activity.Status === 'Closed' ? <>
                                                <span className="closed-status">معلق<img src={infoIcon} alt="" /> </span>
                                            </> : <>
                                                {activity.Status.toLowerCase() === 'Sent'.toLowerCase() ? <>
                                                    <span className="complite-p">تم الإرسال<img src={tickIcon} alt="" /></span>
                                                </> : <>
                                                    تم الإرسال
                                                </>}
                                        ...
                                        <td style={{ minWidth: '200px' }} >
                                            {/* {activity.Replay} */}
                                            {activity.Replay.length > 30 ? `${activity.Replay.substring(0, 30)}...` : activity.Replay}
...
export default ComplaintContentApprentice;

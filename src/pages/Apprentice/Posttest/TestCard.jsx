...
const TestCard = ({ question, options, type, selectedAnswers, setSelectedAnswers, currentAnswer, result, submitted, currentAnswerLabel, required }) => {
    ...
    return (
        <div className="test-card">
            <p className={`${type === 'radio'  && textQuestion}`}> {question}
            ...
            <div className="items-answer-test">
                <>
                    {options.map((option, index) => (
                        <div key={index} className={`item-answer ${option.id === selectedAnswers[question] && classAct}`}>
                            {type === 'radio' && (
                                <>

...
import AddPurchaseRequests from "./AddPurchaseRequests/AddPurchaseRequests";
import EditPurchaseRequests from "./EditPurchaseRequests/EditPurchaseRequests";
        ...
        <div className="header-activity-table">
          ...
          <div className="opration-buttons-activity-table">
            ...
            >
              <Button
                label="Add Core PR"
                className={"button-t button-import "}
                Icon={addTableIcon}
                iconPosition={"left"}
                width={"48%"}
                height={"3rem"}

    ...
    <div ref={ref} className="print-page-container">
      <header className="print-header">
        <div className="header-time">
          ...
          <div className="buttom-time">Employment Requests</div>
        </div>
        ...
        <table className="request-details" style={{ width: "100%" }}>
          <tbody>
            <tr className="request-row">
              <th>Employment Requests type</th>
              <td>employment_requests.type</td>
              <th>Project name</th>
              <td>Community Cohesion as a Driver for Sustainable </td>
            </tr>
            <tr className="request-row">
              <th>ID</th>
              <td>32</td>
            ...
            <tr className="request-row">
              <th>Currency</th>
              <td>TR</td>
              <th>Employment Requests location</th>
              <td>314</td>
            </tr>
            {/* <tr className="request-row">
              <th>PR Date</th>

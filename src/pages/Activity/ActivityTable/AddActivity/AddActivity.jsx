...
const AddActivity = ({ isOpen, onClose, projectData, onSave }) => {
    ...
    return (
        <Modal onClose={onClose} height={'100%'} width={'auto'}>
            <h2 className='header-text-edit-project'>Add Activity</h2>
            ...
            <form onSubmit={handleSubmit} className="edit-project-form">
                ...
                <Button type="submit" label="Add Active" className={'button-edit-project'} />
            </form>
        </Modal>
    );
};

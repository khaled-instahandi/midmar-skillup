...
import AddLeaveRequestCoordinator from './AddLeaveRequestCoordinator';

const sampleData = [
    {
        id: 1, TypeOfAbsence: "Maternity", FromDate: "12/12/2023", ToDate: "14/12/2023",AuthorizedPerson:"khaled alahmad", State: "acceptable"
    },
    {
        id: 2, TypeOfAbsence: "Marriage", FromDate: "12/12/2023", ToDate: "14/12/2023",AuthorizedPerson:"khaled alahmad", State: "rejected"
    },
    {
        id: 3, TypeOfAbsence: "Maternity", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "acceptable"
    },
    {
        id: 4, TypeOfAbsence: "Marriage", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "rejected"
    },
    {
        id: 5, TypeOfAbsence: "Maternity", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "acceptable"
    },
    {
        id: 6, TypeOfAbsence: "Marriage", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "rejected"
    },
    {
        id: 7, TypeOfAbsence: "Maternity", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "acceptable"
    },
    {
        id: 8, TypeOfAbsence: "Marriage", FromDate: "12/12/2023", ToDate: "14/12/2023", AuthorizedPerson:"khaled alahmad", State: "rejected"
    },

];
const defaultData = [...sampleData];

const VacationsCoordinator = () => {
    ...
    return (
        <div className='activity-page'>
            ...
            <div className="activity-table-container">
                    ...
                    <table className="activity-table" style={{ width: '100%' }}>
                        <thead>
                            <tr className='activity-table-header'>
                                ...
                                <th onClick={() => toggleSort('AuthorizedPerson')}>Authorized Person</th>
                ...
                <AddLeaveRequestCoordinator hederText={'Leave Request'}
                    scale={'.9'}
...
export default VacationsCoordinator;

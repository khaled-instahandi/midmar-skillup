...
import './PendingEnrollmentRequests.css'
import { Link } from 'react-router-dom';
import { ReactComponent as CopyIcon } from '../../../../images/copy-icon.svg'
// import { CopyIcon } from 'lucide-react';
const PendingEnrollmentRequests = ({ isOpen, onClose, onSave, label }) => {
    ...
    return (
        <Modal onClose={onClose} height={'auto'}>
            <h2 className='header-text-edit-project'>Pending Enrollment Requests</h2>
            ...
            <form onSubmit={handleSubmit} className="add-sub-activity">
                <div className="trainees-container">
                    ...
                    >
                        <h4>Enrollment Url:</h4>
                        <span onMouseEnter={() => setIsHovered(true)}
                            onMouseLeave={() => setIsHovered(false)} className="copy-link"><Link className='#'>Copy  <CopyIcon /></Link>
                        </span>
                        {isHovered && (
...
export default PendingEnrollmentRequests;

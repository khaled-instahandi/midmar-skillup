...
import CoachExamResult from "./CoachExamResult";

const sampleData = [
  {
    id: 1,
    TrainerName: "خالد الاحمد",
    PreTestMark: "65",
    PostTestMark: "90",
    ProgressPercent: "25",
  },
            ...
            <table className="activity-table">
              <thead>
                <tr className="activity-table-header">
                  ...
                  <th onClick={() => toggleSort("TrainerName")}>اسم المتدرب</th>
...
export default CoachTestDetails;

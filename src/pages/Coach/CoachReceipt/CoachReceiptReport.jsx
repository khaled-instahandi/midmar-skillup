...
function CoachReceiptReport({ isOpen, onClose, projectData, onSave }) {
  ...
  return (
    <Modal onClose={onClose} height={"100%"}>
      <div className="print-page-container">
        <header className="print-header" dir="ltr">
          ...
          <div className="sds">
            <div className="header-section">Service Received Note</div>
...
export default CoachReceiptReport;

...
const ImportExpenses = ({ isOpen, onClose, projectData, onSave, height }) => {
  ...
  return (
    <Modal onClose={onClose} height={"90%"} width={"auto"}>
      <h2 className="header-text-edit-project">Import Expenses (xlsx)</h2>

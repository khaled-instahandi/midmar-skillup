...
const EditItems = ({ isOpen, onClose, projectData, onSave }) => {
    ...
    return (
        <Modal onClose={onClose} height={"100%"} width={"auto"} >
            <h2 className='header-text-edit-project'>Edit Items</h2>
            ...
            <form onSubmit={handleSubmit} className="edit-project-form">
                ...
                <Button type="submit" label="Edit items" className={'button-edit-project'} height={'3rem'} />
            </form>
        </Modal>
    );
};
